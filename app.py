...
jwt = JWTManager(app) # not creating /auth (i.e. new endpoint)

@jwt._user_claims_loader
...
def check_if_token_in_blacklist(decrypt_token):
    return decrypt_token['jti'] in BLACKLIST
